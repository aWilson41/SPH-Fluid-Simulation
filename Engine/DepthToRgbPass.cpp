...
DepthToRgbPass::DepthToRgbPass() : RenderPass("Depth_To_Rgb_Pass")
{
...
void DepthToRgbPass::render(DeferredRenderer* ren)
{
...
void DepthToRgbPass::resizeFramebuffer(int width, int height)
{
